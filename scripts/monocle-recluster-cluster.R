...
meta.file = file.path('stats/umap_recluster',paste0('meta_',prefix,'_class',this.cluster,'.txt.gz'))
umap02.file = file.path('stats/umap_recluster',paste0('umap02_',prefix,'_class',this.cluster,'.txt.gz'))
umap10.file = file.path('stats/umap_recluster',paste0('umap10_',prefix,'_class',this.cluster,'.txt.gz'))
...
broad.clusters = cluster_cells(cds, resolution=1e-5, reduction_method='PCA')@clusters$PCA$clusters
cds = cluster_cells(cds, resolution=1e-3, reduction_method='PCA')
# cds = cluster_cells(cds, resolution=1e-5, reduction_method='UMAP')

push.status(paste0('cluster_cells ',prefix,' cluster_',this.cluster))
...
# Save clusters
saveRDS(this.umap,file=file.path('umap',paste0(prefix,'-scanpy-recluster-class',this.cluster,'.rds')))
...
plot.umap(this.umap,color='sequencing_run_id',file=file.path('figures/umap-recluster',paste0('umap-',prefix,'-batch-class',this.cluster,'_presentation.pdf')),color.label='Region',legend=FALSE,presentation=TRUE,size=size,alpha=alpha)
...
plot.umap(this.umap,color='sequencing_run_id',file=file.path('figures/umap-recluster',paste0('umap-',prefix,'-batch-class',this.cluster,'.pdf')),color.label='Region',legend=TRUE,presentation=FALSE,size=size,alpha=alpha)

# plot.umap(this.umap,color='cluster3',file=file.path('figures/umap-recluster',paste0('umap-',prefix,'-cluster3-class',this.cluster,'_presentation.pdf')),color.label='Cluster',legend=FALSE,presentation=TRUE,size=size,alpha=alpha)
# plot.umap(this.umap,color='cluster3',file=file.path('figures/umap-recluster',paste0('umap-',prefix,'-cluster3-class',this.cluster,'.pdf')),color.label='Cluster',legend=TRUE,presentation=FALSE,size=size,alpha=alpha)

push.status(paste0('plot.umap ',prefix,' cluster_',this.cluster))
