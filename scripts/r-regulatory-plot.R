...
# arguments = c('biccn','atac','ENSMMUG00000011333','0')

# PVALB:  ENSMMUG00000008778
# SST:    ENSMMUG00000000850
# ADARB2: ENSMMUG00000017120
# RBFOX3: ENSMMUG00000023028
# MBP:    ENSMMUG00000011333
# OPALIN: ENSMMUG00000050856
# ENTPD1: ENSMMUG00000022658
# SLC1A2: ENSMMUG00000004329
# SPI1  : ENSMMUG00000015606
...
if (!( nrow(results.this) || nrow(background.this) )) {
	stop('Gene missing')
}
...
ggsave(p,file=file.path('figures/regulatory/tracks',paste0(prefix,'_',atac.prefix,background.prefix,'_all_peaks_tracks_',this.gene,'_',gene.this$external_gene_name,'.pdf')),useDingbats=FALSE)
...
ggarrange(p0,p1,nrow=2,heights=c(1,3))


dir.create('figures/regulatory/tracks',showWarnings=FALSE)
ggsave(p,file=file.path('figures/regulatory/tracks',paste0(prefix,'_',atac.prefix,background.prefix,'_all_peaks_tracks_',this.gene,'_',gene.this$external_gene_name,'.pdf')),useDingbats=FALSE)

methods.merged.pass = readRDS(file.path('rds',paste0(atac.prefix,'_all_marker_peaks_combined.rds')))
