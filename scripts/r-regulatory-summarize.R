...
suppressMessages(ggsave(p,file=file.path('figures/regulatory',paste0(prefix,'_',atac.prefix,'_all_glueP-v-metacellP.pdf')),useDingbats=FALSE))
...
#	geom_smooth(method=lm) +
	...
	ggtitle(this.cell.class)
suppressMessages(ggsave(p,file=file.path('figures/regulatory',paste0(prefix,'_',atac.prefix,'_all_glueScore-v-metacellStdBeta.pdf')),useDingbats=FALSE))
...
#	geom_smooth(method=lm) +
	...
	ggtitle(this.cell.class)
suppressMessages(ggsave(p,file=file.path('figures/regulatory',paste0(prefix,'_',atac.prefix,'_all_glueScore-v-metacellBeta.pdf')),useDingbats=FALSE))
...
p = ggplot(results.combined, aes(glue.score,-log10(glue.pval),color=glue.qval<0.05)) +
	...
	ggtitle(this.cell.class)
suppressMessages(ggsave(p,file=file.path('figures/regulatory',paste0(prefix,'_',atac.prefix,'_all_glueScore-v-glueP.pdf')),useDingbats=FALSE))
...
#	coord_equal() +
	...
	ggtitle(this.cell.class)
suppressMessages(ggsave(p,file=file.path('figures/regulatory',paste0(prefix,'_',atac.prefix,'_all_metacellP-qqplot.pdf')),useDingbats=FALSE))
...
#	coord_equal() +
	...
	ggtitle(this.cell.class)
suppressMessages(ggsave(p,file=file.path('figures/regulatory',paste0(prefix,'_',atac.prefix,'_all_metacellBeta-qqplot.pdf')),useDingbats=FALSE))
...
p = ggplot(peak.counts.long,aes(value,fill=direction)) +
	...
	ylab('Count') +
	ggtitle(this.cell.class)
suppressMessages(ggsave(p,file=file.path('figures/regulatory',paste0(prefix,'_',atac.prefix,'_all_peaks-histogram.pdf')),useDingbats=FALSE))
...
p = ggplot(peak.counts.long,aes(value,fill=direction)) +
	...
	ylab('Count') +
	ggtitle(this.cell.class)
suppressMessages(ggsave(p,file=file.path('figures/regulatory',paste0(prefix,'_',atac.prefix,'_all_peaks-histogram-fixed.pdf')),useDingbats=FALSE))
...
if (nrow(results.inc)) {
	write.table(
		results.inc,
		file=file.path('stats/regulatory',paste0(prefix,'_',atac.prefix,'_all_peaks_inc.txt')),
...
if (nrow(results.dec)) {
	write.table(
		results.dec,
		file=file.path('stats/regulatory',paste0(prefix,'_',atac.prefix,'_all_peaks_dec.txt')),
		sep='\t', quote=FALSE, col.names=FALSE, row.names=FALSE)
}
...
write.table(
	...
	file=file.path('stats/regulatory/bed',paste0(prefix,'_',atac.prefix,'_all_peaks_genes_background.txt')),
	sep='\t',quote=FALSE,row.names=FALSE,col.names=FALSE)

write.table(
	subset(results.sig.bed,gene_dir == '-',select=paste0('V',1:3)),
	file=file.path('stats/regulatory/bed',paste0(prefix,'_',atac.prefix,'_all_peaks_significant_dec.bed')),
	sep='\t',quote=FALSE,row.names=FALSE,col.names=FALSE)

write.table(
	subset(results.sig.bed,gene_dir == '+',select=paste0('V',1:3)),
	file=file.path('stats/regulatory/bed',paste0(prefix,'_',atac.prefix,'_all_peaks_significant_inc.bed')),
	sep='\t',quote=FALSE,row.names=FALSE,col.names=FALSE)

write.table(
	unique(subset(results.sig.bed,TRUE,select=paste0('V',1:3))),
	file=file.path('stats/regulatory/bed',paste0(prefix,'_',atac.prefix,'_all_peaks_significant.bed')),
	sep='\t',quote=FALSE,row.names=FALSE,col.names=FALSE)

write.table(
	unique(subset(results.background.bed,TRUE,select=paste0('V',1:3))),
	file=file.path('stats/regulatory/bed',paste0(prefix,'_',atac.prefix,'_all_peaks_background.bed')),
	sep='\t',quote=FALSE,row.names=FALSE,col.names=FALSE)
